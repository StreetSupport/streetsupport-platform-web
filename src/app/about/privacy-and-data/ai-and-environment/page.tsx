...
export default function AIAndEnvironmentPage() {
  return (
    <div className="max-w-4xl mx-auto p-6">
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <span className="mx-2 text-gray-400">/</span>
                <span className="text-gray-500">AI and Environmental Impact</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold">AI and Environmental Impact</h1>
      </div>

      {/* Content */}
      <div className="prose max-w-none space-y-8">
        <section>
          <h2 className="text-2xl font-semibold mb-4">Taking responsibility</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">How we're using AI</h2>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><a href="https://sustainabilitylinkedin.com/openais-path-to-sustainable-innovation-a-comprehensive-report/?utm_source=chatgpt.com" className="text-blue-600 hover:text-blue-800 underline">OpenAI's Path to Sustainable Innovation: A Comprehensive Report - Sustainability LinkedIn</a></li>
            <li><a href="https://www.macro4.com/blog/six-ways-ibm-is-making-artificial-intelligence-more-sustainable/?utm_source=chatgpt.com" className="text-blue-600 hover:text-blue-800 underline">Six ways IBM is incorporating sustainability into its AI</a></li>
          </ul>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">What we looked at</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">What we found</h2>
          <h3 className="text-xl font-semibold mb-3">Internal and volunteer use:</h3>
          ...
          <h3 className="text-xl font-semibold mb-3">Virtual Assistant:</h3>
          <ul className="list-disc pl-6 space-y-1 mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">Why we're sharing this</h2>
          ...
          <p>If you have any questions about this report or just want to chat about AI and environmental impact in general, please do not hesitate to get in touch with us on <a href="mailto:admin@streetsupport.net" className="text-blue-600 hover:text-blue-800 underline">admin@streetsupport.net</a>.</p>
        </section>

        <hr className="border-gray-200" />

        <section>
          <h2 className="text-2xl font-semibold mb-4">Where our figures come from</h2>
          ...
          <h3 className="text-xl font-semibold mb-3">For AI usage, we looked at:</h3>
          <ul className="list-disc pl-6 space-y-1">
            <li><a href="https://hai.stanford.edu/news/measuring-carbon-footprint-ai-models" className="text-blue-600 hover:text-blue-800 underline">Stanford HAI</a>: A widely cited report that breaks down the energy used in training vs. usage (inference) and gives a range of emissions per prompt on models like GPT-3.</li>
            <li><a href="https://arxiv.org/abs/1906.02243" className="text-blue-600 hover:text-blue-800 underline">Allen Institute for AI</a>: Research that compares the emissions from training large AI models to the lifetime use of several cars. It helps put scale into perspective, even though our focus is on usage, not training.</li>
            <li><a href="https://openai.com/research/gpt-4" className="text-blue-600 hover:text-blue-800 underline">OpenAI GPT-4 Technical Report</a>: Highlights efficiency improvements in newer models, though it doesn't include specific carbon figures.</li>
            <li><a href="https://huggingface.co/blog/sasha/ai-environment-primer" className="text-blue-600 hover:text-blue-800 underline">Hugging Face + Carnegie Mellon</a>: Tracks real-time emissions from AI model use and provides open-source tools to estimate emissions from inference at scale.</li>
          </ul>
