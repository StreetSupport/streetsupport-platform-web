...
export default function PrivacyAndDataPage() {
  return (
    <div className="max-w-4xl mx-auto p-6">
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <span className="mx-2 text-gray-400">/</span>
                <span className="text-gray-500">Our Policies</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold">Your Privacy, Your Data, and Responsible AI</h1>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <p>Want a bit more detail? Check out our <Link href="/about/privacy-and-data/privacy-policy" className="text-blue-600 hover:text-blue-800 underline">Privacy Policy</Link> and <Link href="/about/privacy-and-data/data-protection-policy" className="text-blue-600 hover:text-blue-800 underline">Data Protection Policy</Link>.</p>

        <h2 className="text-2xl font-semibold mb-4">How the Virtual Assistant Works</h2>
        ...
        <p>For full details, check out the <Link href="/about/privacy-and-data/terms-and-conditions" className="text-blue-600 hover:text-blue-800 underline">Terms & Conditions</Link>.</p>

        <h2 className="text-2xl font-semibold mb-4">Keeping Your Information Secure</h2>
        ...
        <h2 className="text-2xl font-semibold mb-4">How We Use AI - Ethically and Responsibly</h2>
        ...
        <p>Want to learn more about how we manage AI responsibly? Check out our <Link href="/about/privacy-and-data/ai-governance" className="text-blue-600 hover:text-blue-800 underline">AI Governance Plan</Link> and our <Link href="/about/privacy-and-data/ai-and-environment" className="text-blue-600 hover:text-blue-800 underline">AI Environmental Impact Report</Link>.</p>

        <h3 className="text-xl font-semibold mb-4">Got Questions? We're Here to Help.</h3>
        <p>Your data and privacy matter to us, and we want to make sure you feel confident and informed. If you have any questions about how we handle your information, just drop us a message at <a href="mailto:admin@streetsupport.net" className="text-blue-600 hover:text-blue-800 underline">admin@streetsupport.net</a>.</p>
