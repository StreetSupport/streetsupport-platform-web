    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="prose max-w-none">
        ...
        <ol className="list-decimal pl-6 space-y-6">
          ...
          <li>
            <h3 className="text-xl font-semibold mb-3">Advertisement Cookies</h3>
          ...
          <li>
            <h3 className="text-xl font-semibold mb-3">Other Cookies</h3>
        ...
        <h2 className="text-2xl font-semibold mb-4">How to Control Cookies in Your Browser</h2>
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li><a href="https://support.google.com/chrome/answer/95647?hl=en" className="text-blue-600 hover:text-blue-800 underline">Google Chrome</a></li>
          <li><a href="https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences" className="text-blue-600 hover:text-blue-800 underline">Mozilla Firefox</a></li>
          <li><a href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac" className="text-blue-600 hover:text-blue-800 underline">Safari</a></li>
          <li><a href="https://support.microsoft.com/en-us/microsoft-edge/manage-cookies-and-site-data-in-microsoft-edge-bf24c7f4-4f60-4fc7-bc10-124fa8b7d44d" className="text-blue-600 hover:text-blue-800 underline">Microsoft Edge</a></li>
        </ul>
        ...
        <p>If you have any questions about this Cookie Policy or how we use cookies, please contact us at: <a href="mailto:admin@streetsupport.net" className="text-blue-600 hover:text-blue-800 underline">admin@streetsupport.net</a></p>
      </div>
    </div>
  );
}