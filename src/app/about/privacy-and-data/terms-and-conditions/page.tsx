...
export default function TermsAndConditionsPage() {
  return (
    <div className="max-w-4xl mx-auto p-6">
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <span className="mx-2 text-gray-400">/</span>
                <span className="text-gray-500">Terms and Conditions of Virtual Assistant</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold">Using the Street Support Network Virtual Assistant – What You Need to Know</h1>
        <p className="mt-4 text-lg">We built the Virtual Assistant to make it easier for you to find the right support when you need it. It asks a few simple questions and points you toward services that might be able to help. But there are a few things you should know before using it.</p>
      </div>

      {/* Content */}
      <div className="prose max-w-none">
        <h2 className="text-2xl font-semibold mb-4">Finding Services, Not Guarantees</h2>
        ...
        <h2 className="text-2xl font-semibold mb-4">We Don't Run These Services</h2>
        ...
        <h2 className="text-2xl font-semibold mb-4">If You Need Urgent Help</h2>
        <ul className="list-disc pl-6 space-y-1">
          <li>The Virtual Assistant is a guide, not an emergency service.</li>
          <li>If you or someone else is in immediate danger, call <a href="tel:999" className="text-blue-600 hover:text-blue-800 underline">999</a> or reach out to emergency support services.</li>
        </ul>

        <h2 className="text-2xl font-semibold mb-4">Your Choice, Always</h2>
        <ul className="list-disc pl-6 space-y-1">
