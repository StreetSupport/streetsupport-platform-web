        ...
        <div className="content-container">
          <div className="prose-content max-w-none">
            <div className="space-y-12">
              ...
              <section>
                <h2 className="heading-2 mb-6 text-brand-l">What Data We Collect and Why</h2>
                <p className="text-body mb-4">We collect different types of data, depending on how you interact with us:</p>
              ...
              <section>
                <h2 className="heading-2 mb-6 text-brand-l">How We Use Your Information</h2>
                <p className="text-body mb-4">We use the data we collect to:</p>
                <ul className="list-disc pl-6 space-y-3 text-body">
              ...
              <section>
                <h2 className="heading-2 mb-6 text-brand-l">How We Protect Your Data</h2>
                <ul className="list-disc pl-6 space-y-3 text-body">
                ...
                <p className="text-body mt-4">For email updates, we use Mailchimp, which processes data on secure servers in the United States. Both IBM and Mailchimp follow the UK Extension to the EU-U.S. Data Privacy Framework, ensuring your data is handled safely.</p>
                <p className="text-body mt-4">You can unsubscribe from updates at any time using the link in our emails or by contacting us.</p>
                <p className="text-body mt-4">Got concerns? Drop us a line at <a href="mailto:admin@streetsupport.net" className="text-brand-a hover:text-brand-b underline">admin@streetsupport.net</a></p>
              </section>

              <section>
                <h2 className="heading-2 mb-6 text-brand-l">Your Rights and Subject Access Requests (SARs)</h2>
                <p className="text-body mb-4">UK GDPR gives you rights over your data, including:</p>
                <ul className="list-disc pl-6 space-y-3 text-body">
              ...
              <section>
                <h2 className="heading-2 mb-6 text-brand-l">How Long We Keep Your Data</h2>
                <p className="text-body mb-4">We only keep data as long as we need it:</p>
                <ul className="list-disc pl-6 space-y-3 text-body">
              ...
              <section>
                ...
                <div className="mt-6">
                  <h3 className="heading-4 mb-4 text-brand-l">Google Analytics</h3>
                  <p className="text-body mb-4">We use <strong>Google Analytics</strong> to understand how visitors interact with our site. This includes:</p>
