...
export default function AIGovernancePage() {
  return (
    <div className="max-w-4xl mx-auto p-6">
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <span className="mx-2 text-gray-400">/</span>
                <span className="text-gray-500">AI Governance Plan</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold">AI Governance Plan</h1>
      </div>
      ...
      <div className="prose max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">Fairness</h2>
          <h5 className="text-lg font-semibold mb-3">What it Means</h5>
          ...
          <h5 className="text-lg font-semibold mb-3">Why it Matters</h5>
          ...
          <h5 className="text-lg font-semibold mb-3">Risks to Watch Out For</h5>
          ...
          <h5 className="text-lg font-semibold mb-3">How We're Tackling These Risks</h5>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">Explainability</h2>
          <h5 className="text-lg font-semibold mb-3">What it Means</h5>
          ...
          <h5 className="text-lg font-semibold mb-3">Actions to Support Explainability</h5>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          ...
          <h5 className="text-lg font-semibold mb-3">Actions to Support Privacy</h5>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          ...
          <h5 className="text-lg font-semibold mb-3">Actions to Support Robustness</h5>
          <ul className="list-disc pl-6 space-y-2">
