...
export default function OurTeamPage() {
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      {/* Core Team Section */}
      <div className="mb-16">
        <h1 className="text-3xl font-bold mb-4">Our Core Team</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
            ...
            />
            <h2 className="text-xl font-semibold mb-2">Matt Lambert</h2>
            <h3 className="text-lg text-blue-600 mb-3">Interim Managing Director</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
            <Image
              ...
              sizes="(max-width: 768px) 128px, 200px"
            />
            <h2 className="text-xl font-semibold mb-2">James Cross</h2>
            <h3 className="text-lg text-blue-600 mb-3">Digital and Technical Projects Lead</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
            <Image
              ...
              sizes="(max-width: 768px) 128px, 200px"
            />
            <h2 className="text-xl font-semibold mb-2">Mara Patraiko</h2>
            <h3 className="text-lg text-blue-600 mb-3">Comms & Engagement</h3>
            <p className="text-gray-700 mb-4">
      ...
      <div className="mb-16">
        <h1 className="text-3xl font-bold mb-4">Our Partnership Co-ordinators</h1>
        <p className="text-lg mb-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
            <Image
              ...
              sizes="(max-width: 768px) 128px, 200px"
            />
            <h2 className="text-xl font-semibold mb-2">Eliz Hopkins</h2>
            <h3 className="text-lg text-blue-600 mb-3">West Midlands</h3>
            <p className="text-gray-700 mb-4">
      ...
      <div className="mb-16">
        <h1 className="text-3xl font-bold mb-4">Our location's contacts</h1>
        <p className="text-lg mb-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
            <Image
              ...
              sizes="(max-width: 768px) 128px, 200px"
            />
            <h2 className="text-xl font-semibold mb-2">Tim Jones</h2>
            <h3 className="text-lg text-blue-600 mb-3">Brighton & Hove</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
            <Image
              ...
              sizes="(max-width: 768px) 128px, 200px"
            />
            <h2 className="text-xl font-semibold mb-2">Helen Wilkenson</h2>
            <h3 className="text-lg text-blue-600 mb-3">Chelmsford</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
            <Image
              ...
              sizes="(max-width: 768px) 128px, 200px"
            />
            <h2 className="text-xl font-semibold mb-2">Crispin Pailing</h2>
            <h3 className="text-lg text-blue-600 mb-3">Liverpool</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
            <Image
              ...
              sizes="(max-width: 768px) 128px, 200px"
            />
            <h2 className="text-xl font-semibold mb-2">Tim Archibold</h2>
            <h3 className="text-lg text-blue-600 mb-3">Luton</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
            <Image
              ...
              sizes="(max-width: 768px) 128px, 200px"
            />
            <h2 className="text-xl font-semibold mb-2">Paul Scotting</h2>
            <h3 className="text-lg text-blue-600 mb-3">Nottingham</h3>
            <p className="text-gray-700 mb-4">
      ...
      <div className="mb-16">
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-semibold mb-2">Vince Lee - Lead Developer</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-2">Oleksandr Seliuchenko - Freelance Developer</h2>
            <p className="text-gray-700">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-2">Alex Atkinson - Designer</h2>
            <p className="text-gray-700">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-2">Liam Roughley - Designer</h2>
            <p className="text-gray-700">
