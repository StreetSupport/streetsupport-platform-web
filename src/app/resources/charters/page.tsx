    ...
    <>
      ...
      <div className="bg-brand-i py-12">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="heading-1 mb-4 text-white">Homelessness Charters</h1>
          <p className="text-lead text-white">What is a Homelessness Charter, and do you need one?</p>
        </div>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <Link href="/leeds/charter" className="block transition-transform hover:scale-105">
            <article className="card !bg-brand-i text-white hover:!bg-brand-q transition-all duration-200 p-6 h-full flex items-center justify-center text-center shadow-lg rounded-lg">
              <h3 className="heading-5 text-white">Leeds Charter</h3>
            </article>
          </Link>
          <Link href="/southampton/charter" className="block transition-transform hover:scale-105">
            <article className="card !bg-brand-i text-white hover:!bg-brand-q transition-all duration-200 p-6 h-full flex items-center justify-center text-center shadow-lg rounded-lg">
