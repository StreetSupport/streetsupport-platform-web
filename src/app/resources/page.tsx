...
export default function ResourcesPage() {
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {/* Header */}
      <div className="bg-brand-q px-6 py-12">
        <h1 className="heading-1">Resources</h1>
        <p className="text-lead">Practical guides to support homelessness efforts and collaboration.</p>
      </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <article className="card card-compact">
              ...
              <p className="text-small mb-4">What it means to give differently, and why you should be thinking about it.</p>
              <Link href="/resources/alternative-giving" className="btn-base btn-primary btn-md w-full">
                Learn more
              </Link>
            </article>
            ...
            <article className="card card-compact">
              ...
              <p className="text-small mb-4">How to make the most impact with your volunteering.</p>
              <Link href="/resources/effective-volunteering" className="btn-base btn-primary btn-md w-full">
                Learn more
              </Link>
            </article>
            ...
            <article className="card card-compact">
              ...
              <p className="text-small mb-4">What is a Homelessness Charter, and do you need one?</p>
              <Link href="/resources/charters" className="btn-base btn-primary btn-md w-full">
                Learn more
              </Link>
            </article>
            ...
            <article className="card card-compact">
              ...
              <p className="text-small mb-4">Our stance on Street Feeding for sustainable support and change.</p>
              <Link href="/resources/street-feeding-groups" className="btn-base btn-primary btn-md w-full">
                Learn more
              </Link>
            </article>
          </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <article className="card card-compact">
              ...
              <p className="text-small mb-4">Guidelines to adapt and align with the Street Support Network identity.</p>
              <Link href="/resources/branding" className="btn-base btn-primary btn-md w-full">
                Learn more
              </Link>
            </article>
            ...
            <article className="card card-compact">
              ...
              <p className="text-small mb-4">How to make the most of being part of Street Support Network.</p>
              <Link href="/resources/partnership-comms" className="btn-base btn-primary btn-md w-full">
                Learn more
              </Link>
            </article>
            ...
            <article className="card card-compact">
              ...
              <p className="text-small mb-4">Strategies to raise awareness and engage your community effectively.</p>
              <Link href="/resources/marketing" className="btn-base btn-primary btn-md w-full">
                Learn more
              </Link>
            </article>
            ...
            <article className="card card-compact">
              ...
              <p className="text-small mb-4">Step-by-step documentation to help you manage and update organisation data effortlessly.</p>
              <Link href="/resources/user-guides" className="btn-base btn-primary btn-md w-full">
                Learn more
              </Link>
            </article>
          </div>
