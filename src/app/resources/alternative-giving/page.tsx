...
export default function AlternativeGivingPage() {
  return (
    <div className="max-w-4xl mx-auto p-6">
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <span className="mx-2 text-gray-400">/</span>
                <span className="text-gray-500">Alternative Giving</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Alternative Giving Funds</h1>
        <p className="text-xl text-gray-700">What it means to give differently, and why you should be thinking about it.</p>
      </div>

      {/* Content */}
      <div className="prose max-w-none">
        <h2 className="text-2xl font-semibold mb-4">What is an alternative giving fund?</h2>
        ...
        <h2 className="text-2xl font-semibold mb-4">How do you set up an alternative giving fund?</h2>
        ...
        <ul className="list-disc pl-6 space-y-2 mb-8">
          <li><a href="/resources/alternative-giving/ag-wins.pdf" className="text-blue-600 hover:text-blue-800 underline">SSN's Alternative Giving Easy Wins sheet</a></li>
          <li><a href="https://youtu.be/afNgjl3g92g?si=eTnbEfmiz4VwluNP" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">SSN's 2023 Network Meeting on Alternative Giving</a></li>
          <li><a href="/resources/alternative-giving/notes-from-ag-event.pdf" className="text-blue-600 hover:text-blue-800 underline">The notes from the above event</a></li>
          <li><a href="https://youtu.be/YoNlXuUoHaM" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">Real Change MCR's PR video with examples of where the fund goes</a></li>
          <li><a href="https://youtu.be/25Hw0nsr0J0" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">Cambridge PR video</a></li>
        </ul>
